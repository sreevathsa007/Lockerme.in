1.Objective : As a Full Stack Developer, complete the features of the application by planning the development in terms of sprints and then push the source code to the GitHub repository. 
...
2.Number of sprints required : 2 sprints

3.Algorithms used : 1.Sorting Algorithm : Merge Sort(Collections.sort()) 
		    2.Search Algorithm : Linear Search.

4.Java concepts used : Interface , Collections , Encapsulation 
